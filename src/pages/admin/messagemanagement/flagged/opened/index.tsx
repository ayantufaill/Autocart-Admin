        ...
        <Box sx={{ px: { xs: '20px', lg: '40px'}, bgcolor: '#F9F9F9', pb:'30px'  }}>
            <Box sx={{ py: '48px', display: "flex", justifyContent: 'space-between', flexWrap: { xs: "wrap", lg: "nowrap" } }}>
                <Box sx={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
                    <Box sx={{ width: '16px', height: '16px', bgcolor: '#EAB308', borderRadius: '4px' }}></Box>
                    <Typography sx={{ color: '1F2937', fontSize: { xs: '20px', lg: '20px' }, fontWeight: 600 }}>Flagged</Typography>
                </Box>
                <Box
                    sx={{
                        display: "flex",
