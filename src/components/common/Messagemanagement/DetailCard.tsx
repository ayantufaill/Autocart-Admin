...
const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  return (
    <Box
      sx={{ display: "flex", flexDirection: "column", gap: "17px", flex: 1 }}
    >
      <Typography sx={{ color: "#1F2937", fontSize: "20px", fontWeight: 600 }}>
        {title}
      </Typography>
      <Box
        sx={{
  ...
  return (
    ...
    >
      <Box sx={{ width: { xs: "100%", lg: "45%" } }}>
        <ProfileCard
          title="Sender"
          imageSrc="/images/MessageFlagged/image 88.png"
          userData={senderData}
        />
      </Box>
      <Box
      ...
      >
        <SyncAltOutlinedIcon
          sx={{ color: "#9CA3AF", width: "40px", height: "40px" }}
        />
      </Box>
      <Box sx={{ width: { xs: "100%", lg: "45%" } }}>
        <ProfileCard
          title="Receiver"
          imageSrc="/images/MessageFlagged/image 87.png"
